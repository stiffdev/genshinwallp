...
class Live2Wllp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: _ButterFlyAssetVideoInList(),
    );
  }
}
            ...
            children: <Widget>[
              ...
              Stack(
                  ...
                  children: <Widget>[
                    ...
                    Image.asset('lib/src/assets/gem.png'),
                  ]),
            ],
          ),
        ])),
...
class _PlayerVideoAndPopPageState extends State<_PlayerVideoAndPopPage> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('lib/src/assets/genshintro.mp4');
